...
class DataViewer:
    def __init__(self):
        ...
        self.plotter.define_input_vector('estimated_state', [
            'pn_e', 'pe_e', 'h_e', 'Va_e', 'alpha_e', 'beta_e', 'phi_e',
            'theta_e', 'chi_e', 'p_e', 'q_e', 'r_e', 'Vg_e', 'wn_e', 'we_e',
            'psi_e', 'bx_e', 'by_e', 'bz_e'
        ])
    ...
    def update(self, true_state, estimated_state, commanded_state, delta, ts):
        ...
        true_state_list = [
            true_state.north, true_state.east, true_state.altitude,
            true_state.Va, true_state.alpha, true_state.beta, true_state.phi,
        ...
        estimated_state_list = [
            estimated_state.north, estimated_state.east,
            estimated_state.altitude, estimated_state.Va,
            estimated_state.alpha, estimated_state.beta, estimated_state.phi,
            estimated_state.theta, estimated_state.chi, estimated_state.p,
            estimated_state.q, estimated_state.r, estimated_state.Vg,
            estimated_state.wn, estimated_state.we, estimated_state.psi,
            estimated_state.bx, estimated_state.by, estimated_state.bz
        ]
        delta_list = [
            delta.elevator, delta.aileron, delta.rudder, delta.throttle
        ]
