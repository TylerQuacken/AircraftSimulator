...
class SensorViewer:
    def __init__(self):
        ...
        first_row = [
            gyro_x_plots, gyro_y_plots, gyro_z_plots, abs_pressure_plots
        ]
        ...
        diff_pressure_plots = PlotboxArgs(plots=['diff_pressure'],
                                          ...
                                          time_window=time_window_length)
        second_row = [
            accel_x_plots, accel_y_plots, accel_z_plots, diff_pressure_plots
        ]
        ...
        self.plotter.define_input_vector('sensors', [
            'gyro_x', 'gyro_y', 'gyro_z', 'absolute_pressure', 'accel_x',
            'accel_y', 'accel_z', 'diff_pressure', 'gps_n', 'gps_e', 'gps_h',
            'gps_Vg', 'gps_course'
        ])
        # plot timer
        self.time = 0.
    ...
    def update(self, sensors, ts):
        ...
        sensor_list = [
            ...
            sensors.gps_e, sensors.gps_h, sensors.gps_Vg, sensors.gps_course
        ]
