...
from chap2.draw_mav import drawMav as DrawMav
...
class mavViewer():
    ...
    def update(self, state):
        ...
        view_location = Vector(state.east, state.north,
                               state.altitude)  # defined in ENU coordinates
